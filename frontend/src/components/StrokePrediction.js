...
//     // Convert Yes/No fields to 1/0 for backend
//     const mappedData = {
//       ...formData,
...
//         // Save prediction history in localStorage
...
//         // Save prediction history in localStorage (optional)
//         const history = JSON.parse(localStorage.getItem('predictionHistory')) || [];
//         const newEntry = {
//           predictionType: "Brain Stroke",
//           dateTime: new Date().toLocaleString(),
...
//             riskPercentage: result.prediction === 1 ? 85 : 0,
//             features: { ...formData },
//             precautions: ''  // you can update this later when you add precautions input
//           })
//         });

//         const saveResult = await saveResponse.json();
//         console.log("✅ Saved stroke prediction to backend:", saveResult);
